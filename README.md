...
3. In Chrome go to the extensions page (`chrome://extensions`) and enable Developer mode.
4. Click Load unpacked on top left corner and then select the `bypass-paywalls-chrome-master` folder to import it.
